...
export const BIOME_DEFINITIONS=Object.freeze({
 ...
 forest:biome('Oakwood Forest','#658657','grass',.48,.62,13,['oak','birch'],.64,['house','tower','shrine','dungeon']),
 dense_forest:biome('Deepwood','#405e43','grass',.43,.82,18,['great_oak','pine'],.86,['tower','house','temple']),
 autumn_forest:biome('Amberwood','#b29154','grass',.36,.52,11,['amber','birch'],.48,['house','shrine','wall']),
 ...
 mountain:biome('Crown Ranges','#929d9e','stone',.3,.42,16,['pine'],.08,['shrine','fortress','watchtower'],{roughness:3.2}),
 beach:biome('Broken Coast','#d2c39c','sand',.5,.5,2,[],0,['bridge','camp'],{subsurface:'gravel',roughness:.6}),
 ocean:biome('Outer Sea','#5e8799','sand',.5,.5,4,[],0,[],{subsurface:'gravel',roughness:1}),
 marsh:biome('Reedwater Marsh','#6a8061','grass',.62,.95,5,['oak'],.3,['bridge','house','shrine'],{roughness:.8}),
