...
export function paintBlockStyle(ctx,type,side){
 const palette={leaf_litter:['#8c663e','#b79150','#665138'],blossom_litter:['#c693aa','#edc5d5','#a37786'],forest_moss:['#537541','#718d49','#405d36'],mud:['#645c43','#776b4b','#514c3c'],jungle_leaf:['#356c38','#4b8640','#29562f'],mangrove_leaf:['#648448','#829b55','#4b6c3a'],spectral_leaf:['#54788c','#7297a9','#3d5e78'],pear_leaf:['#88b249','#a8c65c','#64963b'],plum_leaf:['#825f92','#a47ab0','#694d80'],grass:['#71b449','#86c858','#61a03c'],dirt:['#987048','#a67d51','#805d3f'],stone:['#909ba5','#a1acb5','#7e8993'],sand:['#e5cd8c','#efdb9f','#d5bc7c'],red_sand:['#c7804e','#d8935b','#b26a40'],snow:['#e8f2f5','#ffffff','#d2e3ea'],leaf:['#59a24a','#73b859','#498b3b'],pine:['#42845b','#55986b','#38714f'],cherry_leaf:['#e4a5c4','#f2c1d7','#cf90b3'],autumnleaf:['#d69540','#eab657','#b77731']};
