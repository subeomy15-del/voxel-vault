import {slotKey} from './save.js?v=31';
import {saveHealth,setSaveHealth,storageFailure} from './save-health.js?v=31';
...
export async function openDurableStorage(local){
  const worker=new Worker(new URL('./save-worker.js?v=31',import.meta.url),{type:'module'}),storage=new DurableStorage(local,worker);
