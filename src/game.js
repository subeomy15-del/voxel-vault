import { NETHER_EXIT,NETHER_END,realmDestination } from './nether.js?v=23';
import { installOutposts,FORGE_OFFERS } from './expeditions.js?v=23';
import { canonicalItem,normalizeResources } from './resource-map.js?v=23';
import { installDragonArena,summonDragon,defeatDragon,DRAGON_ALTAR } from './dragon.js?v=23';
import { captureRealm,emptyRealm,RIFT_ANCHORS } from './realms.js?v=23';
import { World,cellKey,WORLD_LIMIT,WORLD_BOTTOM,WORLD_TOP } from './world.js?v=23';
import { ITEMS,BLOCKS,SMELTING,CROPS,CROP_BLOCKS,MATURE_CROPS,TIMBER,RECIPES,craft,hash,dailySeed } from './data.js?v=23';
import { freshState,loadState,saveState,importLegacy } from './save.js?v=23';
import { ENEMIES,launchBolt,updateEnemies,targetMob } from './combat.js?v=23';
import { movePlayer,requestJump } from './movement.js?v=23';
import { overlapsBlock } from './shapes.js?v=23';
import { activeEffect,canEat,consumeFood,tickSurvival } from './survival.js?v=23';
import { ANIMALS,animalKind } from './wildlife.js?v=23';
