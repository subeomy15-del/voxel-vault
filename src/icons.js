...
function art(name){
  ...
  if(name==='crossbow')return handle+path('m5 6 7-3 9 7 11 10-1 10-4-2-1-7-8-9-8-2-5 1Z',c,edge)+line('M6 7 29 29','#ebe3c6')+path('m15 26-3-3L31 3l4-1-1 5Z','#bec8c1',edge)+line('m22 13 8-8',metal);
  ...
  if(name==='arrows')return line('m6 30 21-21m-13 22 14-14','#a89168',2)+path('m24 8 9-6-3 11Zm1 8 9-5-3 10Z','#c4d1d0',edge)+path('m5 23 6 5-5 6-4-7Zm10 2 5 4-5 6-3-6Z','#ded4b3');
  ...
  if(name==='seeds')return path('m10 10 16 1 5 21q-14 6-25-1Z','#a49367',edge)+path('m11 5 13-2-1 9-10-1Z','#bfae7d',edge)+line('M10 12h17','#675f42',2)+path('M17 29V17m0 7q-8-1-6-6 7 1 6 6m0-2q8-1 7-6-7 0-7 6','none','#e8db9c',1.8);
  ...
  if(name==='cloth')return path('M6 7h24l-3 22H5Z',c,edge)+path('m6 7 7 4-3 23 18-2 2-25Z','#ece1c0',edge)+line('m15 14 10-1m-10 5 9-1m-10 5 10-1','#aeaa8d');
