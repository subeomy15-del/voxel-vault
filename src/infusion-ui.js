...
import {ENCHANTS,ALTARS,OFFERS,INFUSION_TIERS,itemTags,enchantText} from './infusion-registry.js?v=35';
import {nearbyAltar,enchantPool,infusionMaterial} from './infusions.js?v=35';
