...
import { BLOCKS, ITEMS, hash } from './data.js?v=26';
import { CHUNK, WORLD_LIMIT } from './world.js?v=26';
import { ENEMIES } from './combat.js?v=26';
import { textureCanvas,TILE,ATLAS_COLS,ATLAS_WIDTH,ATLAS_HEIGHT } from './textures.js?v=26';
import { Scenery } from './scenery.js?v=26';
import { boxesFor } from './shapes.js?v=26';
import { animalModel,bowModel,arrowModel,toolModel } from './models.js?v=26';
import { itemModel } from './item-model.js?v=26';
import { dragonModel,animateDragon } from './dragon-model.js?v=26';
import { RiftEffects } from './rift-effects.js?v=26';
import { PostProcess } from './post-process.js?v=26';
import { PlayerModel } from './player-model.js?v=26';
import { cameraPosition } from './perspective.js?v=26';
import { ViewEffects } from './view-effects.js?v=26';
export class Renderer {
  constructor(container,settings){
    ...
    this.worker=new Worker(new URL('./terrain-worker.js?v=26',import.meta.url),{type:'module'});
