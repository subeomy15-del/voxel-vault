...
import { BLOCKS, ITEMS, hash } from './data.js?v=14';
import { CHUNK, WORLD_LIMIT } from './world.js?v=14';
import { ENEMIES } from './combat.js?v=14';
import { textureCanvas,TILE,ATLAS_COLS,ATLAS_WIDTH,ATLAS_HEIGHT } from './textures.js?v=14';
import { Scenery } from './scenery.js?v=14';
import { boxesFor } from './shapes.js?v=14';
import { animalModel,bowModel,arrowModel,toolModel } from './models.js?v=14';
import { itemModel } from './item-model.js?v=14';
import { dragonModel,animateDragon } from './dragon-model.js?v=14';
import { RiftEffects } from './rift-effects.js?v=14';
import { PostProcess } from './post-process.js?v=14';
import { PlayerModel } from './player-model.js?v=14';
import { cameraPosition } from './perspective.js?v=14';
import { ViewEffects } from './view-effects.js?v=14';
export class Renderer {
  constructor(container,settings){
    ...
    this.worker=new Worker(new URL('./terrain-worker.js?v=14',import.meta.url),{type:'module'});
