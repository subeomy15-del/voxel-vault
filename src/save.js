import {readExploration} from './exploration.js?v=33';
import {normalizeRoll,recoverInfusion} from './infusions.js?v=33';
import {ENCHANTS} from './infusion-registry.js?v=33';
import {normalizeBrews,DRINK_COOLDOWN} from './potions.js?v=33';
import {WORLDGEN_VERSION} from './biome-registry.js?v=33';
import { recoverDelayedActions } from './delayed-actions.js?v=33';
import { readDocument,writeDocument,setSaveHealth,storageFailure } from './save-health.js?v=33';
import { VERSION, ITEMS, STARTER_BAR, starterInventory, dailySeed, BLOCKS,CROPS,EFFECTS } from './data.js?v=33';
import { ANIMALS } from './wildlife.js?v=33';
import { normalizeResources } from './resource-map.js?v=33';
import { REALM_FIELDS,captureRealm } from './realms.js?v=33';
import { defaultSettings, normalizeSettings } from './settings.js?v=33';
export { defaultSettings } from './settings.js?v=33';
...
export function loadState(storage,mode='adventure') {
  try {
    ...
    const s=freshState(Number.isFinite(raw.seed)?raw.seed:7821,mode);s.terrain=[5,6,7].includes(raw.terrain)?raw.terrain:5;
