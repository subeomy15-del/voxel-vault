export function startupFailure(error,stage='initialization'){
  ...
  if(stage==='save')return {title:'Your world could not be opened',hint:'Your stored data has been kept. Close other game tabs and reload to retry. No replacement world was started.',stage,detail};
