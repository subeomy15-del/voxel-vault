...
export class StructureGenerator {
 ...
 layout(site){let layout=this.layouts.get(site.id);if(!layout){layout=buildStructure(site.type,site.seed,site.biome,this.world.terrain);this.layouts.set(site.id,layout);}return layout;}
...
export function biomeSupplies(biome){return ({desert:{glass:3},badlands:{knight_heart:1},frozen_badlands:{frost_arrows:6},jungle:{watermelon:2},cherry:{cherry_leaf:6},conifer:{pinewood:5},autumn_forest:{autumnleaf:6},marsh:{fiber:5},snow:{white_wool:3},snow_plains:{coal:4},mountain:{iron_ingot:2},beach:{water_flask:2},river:{clay:4},forest:{apple:3},dense_forest:{mushroom:3},savanna:{leather:2},meadow:{wheat:4}})[biome]||{};}
