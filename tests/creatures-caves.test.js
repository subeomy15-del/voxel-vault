...
import {CREATURES,NEW_ANIMALS,creatureSpawn} from '../src/creature-registry.js?v=35';
import {ENEMIES,warpCreature,updateEnemies} from '../src/combat.js?v=35';
import {creatureModel,animateCreature} from '../src/creature-model.js?v=35';
import {ITEMS,BLOCKS} from '../src/data.js?v=35';
import {ParticlePool} from '../src/particles.js?v=35';
import {freshState,saveState,loadState} from '../src/save.js?v=35';
import {transform} from '../src/structure-templates.js?v=35';
