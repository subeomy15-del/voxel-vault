...
import {freshState,saveState,loadState} from '../src/save.js?v=24';
import {summonDragon,DRAGON_TOWERS} from '../src/dragon.js?v=24';
import {launchBolt,updateProjectiles} from '../src/combat.js?v=24';
