...
import {freshState,saveState,loadState} from '../src/save.js?v=32';
import {summonDragon,DRAGON_TOWERS} from '../src/dragon.js?v=32';
import {launchBolt,updateProjectiles} from '../src/combat.js?v=32';
