...
import {DurableStorage} from '../src/durable-storage.js?v=36';
import {EditMap} from '../src/edit-map.js?v=36';
import {freshState,slotKey} from '../src/save.js?v=36';
import {saveHealth} from '../src/save-health.js?v=36';
