...
import { cameraPosition } from '../src/perspective.js?v=15';
import { meshChunk } from '../src/mesh.js?v=15';
...
test('Rift Run requires reaching each anchor, rewards once, and saves completion',async()=>{
 const {RIFT_ANCHORS}=await import('../src/realms.js?v=15');const g=game();g.start('ender');assert.equal(g.collectAnchor('dawn'),false);g.state.elapsed+=20;
