...
import { freshState,loadState,saveState } from '../src/save.js?v=16';
import { ITEMS,RECIPES,craft } from '../src/data.js?v=16';
import { cameraPosition } from '../src/perspective.js?v=16';
import { meshChunk } from '../src/mesh.js?v=16';
...
test('Rift Run requires reaching each anchor, rewards once, and saves completion',async()=>{
 const {RIFT_ANCHORS}=await import('../src/realms.js?v=16');const g=game();g.start('ender');assert.equal(g.collectAnchor('dawn'),false);g.state.elapsed+=20;
