...
import { World,WORLD_BOTTOM,WORLD_LIMIT } from '../src/world.js?v=32';
import { Game } from '../src/game.js?v=32';
import { ITEMS,craft,starterInventory,dailySeed } from '../src/data.js?v=32';
import { freshState,loadState,saveState,slotKey,importLegacy } from '../src/save.js?v=32';
