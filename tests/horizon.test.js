...
import { findMobPath,visibleBetween } from '../src/navigation.js?v=34';
import { ANIMALS } from '../src/wildlife.js?v=34';
import { targetMob } from '../src/combat.js?v=34';
...
test('version 5 worlds retain their terrain and new worlds use the smoother generator',()=>{
  ...
  assert.ok(different>100);assert.equal(freshState().terrain,8);
});
