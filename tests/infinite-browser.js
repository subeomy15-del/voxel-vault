...
try{
 ...
 await ev(`(async()=>{const m=await import('/src/main.js?v=31');window.g=m.game;window.v=m.renderer;window.ui=m.ui;})()`);
 ...
 await ev(`(async()=>{const m=await import('/src/main.js?v=31');window.g=m.game;window.v=m.renderer;window.ui=m.ui;g.start('creative');g.pause('pause');})()`);
