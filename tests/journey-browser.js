...
try{
 ...
 await ev(`(async()=>{const m=await import('/src/main.js?v=26');window.g=m.game;window.ui=m.ui;g.start('adventure',true);g.pause('pause');g.screen=null;ui.render();})()`);await sleep(1200);
 ...
 await ev(`(async()=>{const m=await import('/src/main.js?v=26');window.g=m.game;window.ui=m.ui;g.start();g.pause('journal');ui.render();})()`);
