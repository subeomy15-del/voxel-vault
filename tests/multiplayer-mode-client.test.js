...
import { Multiplayer } from '../src/multiplayer.js?v=35';
import { MultiplayerModes } from '../src/multiplayer-modes.js?v=35';
import { BEDWARS_BLOCKS, BEDWARS_SPAWNS, MODE_RULES, mapEdits } from '../src/mode-rules.js?v=35';
