...
import { Multiplayer } from '../src/multiplayer.js?v=38';
import { MultiplayerModes } from '../src/multiplayer-modes.js?v=38';
import { BEDWARS_BLOCKS, BEDWARS_SPAWNS, MODE_RULES, mapEdits } from '../src/mode-rules.js?v=38';
