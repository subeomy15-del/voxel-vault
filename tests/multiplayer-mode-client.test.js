...
import { Multiplayer } from '../src/multiplayer.js?v=36';
import { MultiplayerModes } from '../src/multiplayer-modes.js?v=36';
import { BEDWARS_BLOCKS, BEDWARS_SPAWNS, MODE_RULES, mapEdits } from '../src/mode-rules.js?v=36';
