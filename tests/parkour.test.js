...
import { Parkour } from '../src/parkour.js?v=38';
import { CLOUDSTEP } from '../src/parkour-course.js?v=38';
import { movementInput, releaseJump } from '../src/movement.js?v=38';
import { slotKey } from '../src/save.js?v=38';
