...
try{
 ...
 await c.evaluate(`(async()=>{
  const main=await import('/src/main.js?v=27'),THREE=await import('/vendor/three.module.js'),{ITEMS}=await import('/src/data.js?v=27'),{itemModel}=await import('/src/item-model.js?v=27');
