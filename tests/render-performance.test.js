...
import { CameraMotion } from '../src/camera-motion.js?v=37';
import { FrameBudget, renderOptions } from '../src/render-performance.js?v=37';
import { ParticlePool } from '../src/particles.js?v=37';
import { MovementEffects } from '../src/movement-effects.js?v=37';
