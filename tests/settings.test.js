...
import { defaultSettings, normalizeSettings, applyQualityPreset, updateSetting } from '../src/settings.js?v=38';
import { loadSettings, saveSettings } from '../src/save.js?v=38';
