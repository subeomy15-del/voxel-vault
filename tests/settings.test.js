...
import { defaultSettings, normalizeSettings, applyQualityPreset, updateSetting } from '../src/settings.js?v=37';
import { loadSettings, saveSettings } from '../src/save.js?v=37';
