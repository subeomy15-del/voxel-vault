...
import { defaultSettings, normalizeSettings, applyQualityPreset, updateSetting } from '../src/settings.js?v=32';
import { loadSettings, saveSettings } from '../src/save.js?v=32';
