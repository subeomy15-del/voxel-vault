...
import { ITEMS,BLOCKS,CROPS,RECIPES,ORE_GLIDERS,canCraft,craft } from '../src/data.js?v=23';
import { ANIMALS,animalKind } from '../src/wildlife.js?v=23';
import { tickSurvival,canEat } from '../src/survival.js?v=23';
import { updateProjectiles } from '../src/combat.js?v=23';
import { loadState } from '../src/save.js?v=23';
