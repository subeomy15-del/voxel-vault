...
import { ITEMS,BLOCKS,CROPS,RECIPES,ORE_GLIDERS,canCraft,craft } from '../src/data.js?v=18';
import { ANIMALS,animalKind } from '../src/wildlife.js?v=18';
import { tickSurvival,canEat } from '../src/survival.js?v=18';
import { updateProjectiles } from '../src/combat.js?v=18';
import { loadState } from '../src/save.js?v=18';
