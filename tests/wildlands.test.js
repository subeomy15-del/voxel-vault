...
import { ITEMS,BLOCKS,CROPS,RECIPES,ORE_GLIDERS,canCraft,craft } from '../src/data.js?v=35';
import { ANIMALS,animalKind } from '../src/wildlife.js?v=35';
import { tickSurvival,canEat } from '../src/survival.js?v=35';
