...
import { ITEMS,BLOCKS,CROPS,RECIPES,ORE_GLIDERS,canCraft,craft } from '../src/data.js?v=34';
import { ANIMALS,animalKind } from '../src/wildlife.js?v=34';
import { tickSurvival,canEat } from '../src/survival.js?v=34';
