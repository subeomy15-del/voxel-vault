...
import { ITEMS,BLOCKS,CROPS,RECIPES,ORE_GLIDERS,canCraft,craft } from '../src/data.js?v=16';
import { ANIMALS,animalKind } from '../src/wildlife.js?v=16';
import { tickSurvival,canEat } from '../src/survival.js?v=16';
import { updateProjectiles } from '../src/combat.js?v=16';
import { loadState } from '../src/save.js?v=16';
