...
import { ITEMS,BLOCKS,CROPS,RECIPES,ORE_GLIDERS,canCraft,craft } from '../src/data.js?v=33';
import { ANIMALS,animalKind } from '../src/wildlife.js?v=33';
import { tickSurvival,canEat } from '../src/survival.js?v=33';
import { updateProjectiles } from '../src/combat.js?v=33';
import { loadState } from '../src/save.js?v=33';
