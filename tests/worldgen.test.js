...
import {BLOCKS} from '../src/data.js?v=35';
import {freshState,loadState,saveState} from '../src/save.js?v=35';
import {climateAt} from '../src/climate.js?v=35';
import {BIOME_DEFINITIONS} from '../src/legacy-biomes.js?v=35';
import {STRUCTURE_TYPES,buildStructure,transform} from '../src/structure-templates.js?v=35';
